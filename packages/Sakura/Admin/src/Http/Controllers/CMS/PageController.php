...
namespace Sakura\Admin\Http\Controllers\CMS;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Sakura\Admin\DataGrids\CMS\CMSPageDataGrid;
...
class PageController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'url_key'      => ['required', 'unique:cms_page_translations,url_key', new \Sakura\Core\Rules\Slug],
            'page_title'   => 'required',
            'channels'     => 'required',
    ...
    public function update(int $id)
    {
        ...
        $this->validate(request(), [
            $locale.'.url_key'      => ['required', new \Sakura\Core\Rules\Slug, function ($attribute, $value, $fail) use ($id) {
