...
use Sakura\Admin\DataGrids\Catalog\ProductDataGrid;
use Sakura\Admin\Http\Controllers\Controller;
use Sakura\Admin\Http\Requests\InventoryRequest;
use Sakura\Admin\Http\Requests\MassDestroyRequest;
use Sakura\Admin\Http\Requests\MassUpdateRequest;
use Sakura\Admin\Http\Requests\ProductForm;
use Sakura\Admin\Http\Resources\AttributeResource;
use Sakura\Admin\Http\Resources\ProductResource;
use Sakura\Attribute\Repositories\AttributeFamilyRepository;
use Sakura\Core\Rules\Slug;
use Sakura\Product\Helpers\ProductType;
...
class ProductController extends Controller
{
    ...
    */
    ...
    {
        dd(view('admin::catalog.products.create'));
        $families = $this->attributeFamilyRepository->all();
