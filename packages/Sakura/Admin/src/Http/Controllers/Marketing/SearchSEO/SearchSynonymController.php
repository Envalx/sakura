...
namespace Sakura\Admin\Http\Controllers\Marketing\SearchSEO;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use Sakura\Admin\DataGrids\Marketing\SearchSEO\SearchSynonymDataGrid;
use Sakura\Admin\Http\Controllers\Controller;
use Sakura\Admin\Http\Requests\MassDestroyRequest;
use Sakura\Marketing\Repositories\SearchSynonymRepository;
