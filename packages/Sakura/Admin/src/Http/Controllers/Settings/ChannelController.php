...
use Sakura\Admin\DataGrids\Settings\ChannelDataGrid;
...
class ChannelController extends Controller
{
    ...
    public function store()
    {
        $data = $this->validate(request(), [
            /* general */
            'code'                  => ['required', 'unique:channels,code', new \Sakura\Core\Rules\Code],
            'name'                  => 'required',
    ...
    public function update(int $id)
    {
        ...
        $data = $this->validate(request(), [
            /* general */
            'code'                             => ['required', 'unique:channels,code,'.$id, new \Sakura\Core\Rules\Code],
