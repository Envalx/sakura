{!! view_render_event('application.admin.catalog.product.edit.form.inventories.controls.before', ['product' => $product]) !!}
...
<v-inventories>
    ...
    @foreach (app(\Sakura\Inventory\Repositories\InventorySourceRepository::class)->findWhere(['status' => 1]) as $inventorySource)
        @php
...
{!! view_render_event('application.admin.catalog.product.edit.form.inventories.controls.after', ['product' => $product]) !!}
