<x-admin::layouts>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        ...
        <div class="flex items-center gap-x-2.5">
            ...
            {!! view_render_event('application.admin.catalog.products.create.before') !!}
            ...
            {!! view_render_event('application.admin.catalog.products.create.after') !!}
        </div>
    </div>

    {!! view_render_event('application.admin.catalog.products.list.before') !!}
    ...
    {!! view_render_event('application.admin.catalog.products.list.after') !!}
                        ...
                        <x-admin::modal ref="productCreateModal">
                            ...
                            <x-slot:content>
                                <div v-show="! attributes.length">
                                    {!! view_render_event('application.admin.catalog.products.create_form.general.controls.before') !!}
                                    ...
                                    {!! view_render_event('application.admin.catalog.products.create_form.general.controls.after') !!}
                                </div>

                                <div v-show="attributes.length">
                                    {!! view_render_event('application.admin.catalog.products.create_form.attributes.controls.before') !!}
