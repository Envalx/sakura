...
<head>
    ...
    {!! view_render_event('application.admin.layout.head.before') !!}
    ...
    <link
        rel="preload"
        as="image"
        href="{{ url('cache/logo/application.png') }}"
    >
    ...
    @else
        <link
            type="image/x-icon"
            href="{{ application_asset('images/favicon.ico') }}"
            rel="shortcut icon"
            sizes="16x16"
        />
    @endif
    ...
    {!! view_render_event('application.admin.layout.head.after') !!}
</head>

<body class="h-full dark:bg-gray-950">
    {!! view_render_event('application.admin.layout.body.before') !!}
    ...
    >
        ...
        {!! view_render_event('application.admin.layout.content.before') !!}
        ...
        >
            ...
            <div class="max-w-full flex-1 bg-white px-4 pb-6 pt-3 transition-all duration-300 dark:bg-gray-950 max-lg:!px-4 ltr:pl-[286px] group-[.sidebar-collapsed]/container:ltr:pl-[85px] rtl:pr-[286px] group-[.sidebar-collapsed]/container:rtl:pr-[85px]">
                ...
                <!-- Todo @suraj-Sakura need to optimize below statement. -->
        ...
        {!! view_render_event('application.admin.layout.content.after') !!}
    </div>

    {!! view_render_event('application.admin.layout.body.after') !!}

    @stack('scripts')

    {!! view_render_event('application.admin.layout.vue-app-mount.before') !!}
    ...
    {!! view_render_event('application.admin.layout.vue-app-mount.after') !!}
</body>
