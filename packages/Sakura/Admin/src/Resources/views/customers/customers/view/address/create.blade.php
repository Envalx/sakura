...
@pushOnce('scripts')
    ...
    >
        ...
        {!! view_render_event('application.admin.customers.addresses.create.before') !!}
        ...
        >
            <form @submit="handleSubmit($event, create)">
                {!! view_render_event('application.admin.customers.addresses.create.create_form_controls.before') !!}
                ...
                <x-admin::modal ref="createAddress">
                    ...
                    <x-slot:content>
                        ...
                        {!! view_render_event('application.admin.customers.create.after') !!}
                    </x-slot>
                ...
                {!! view_render_event('application.admin.customers.addresses.create.create_form_controls.after') !!}

            </form>
        </x-admin::form>

        {!! view_render_event('application.admin.customers.addresses.create.after') !!}
