...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            {!! view_render_event('application.admin.customers.addresses.edit.before') !!}

            <x-admin::form
                v-slot="{ meta, errors, handleSubmit }"
                as="div"
            >
                {!! view_render_event('application.admin.customers.addresses.edit.edit_form_controls.before') !!}
                ...
                >
                    ...
                    <x-admin::modal ref="customerAddressModal">
                        ...
                        <!-- Modal Content -->
                        <x-slot:content>
                            {!! view_render_event('application.admin.customer.addresses.edit.before') !!}
                            ...
                            {!! view_render_event('application.admin.customers.edit.after') !!}
                        </x-slot>
                ...
                {!! view_render_event('application.admin.customers.addresses.edit.edit_form_controls.after') !!}

            </x-admin::form>

            {!! view_render_event('application.admin.customers.addresses.edit.after') !!}
        </div>
    </script>
