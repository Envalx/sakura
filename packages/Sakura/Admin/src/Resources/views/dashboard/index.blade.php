<x-admin::layouts>
    ...
    <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
        ...
        <div class="flex flex-1 flex-col gap-8 max-xl:flex-auto">
            {!! view_render_event('application.admin.dashboard.overall_details.before') !!}
            ...
            {!! view_render_event('application.admin.dashboard.overall_details.after') !!}

            {!! view_render_event('application.admin.dashboard.todays_details.before') !!}
            ...
            {!! view_render_event('application.admin.dashboard.todays_details.after') !!}

            {!! view_render_event('application.admin.dashboard.stock_thereshold.before') !!}
            <!-- Stock Thereshold -->
            <div class="flex flex-col gap-2">
                <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
            ...
            {!! view_render_event('application.admin.dashboard.stock_thereshold.after') !!}
        </div>
        ...
        <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
            ...
            {!! view_render_event('application.admin.dashboard.store_stats.before') !!}
            ...
            {!! view_render_event('application.admin.dashboard.store_stats.after') !!}
        </div>
    </div>
    ...
    @pushOnce('scripts')
        <script
            type="module"
            src="{{ application_asset('js/chart.js') }}"
        >
        </script>
