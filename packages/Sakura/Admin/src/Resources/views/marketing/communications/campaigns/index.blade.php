<x-admin::layouts>
    ...
    {!! view_render_event('application.admin.marketing.communications.campaigns.list.before') !!}

    <x-admin::datagrid :src="route('admin.marketing.communications.campaigns.index')" />

    {!! view_render_event('application.admin.marketing.communications.campaigns.list.after') !!}
