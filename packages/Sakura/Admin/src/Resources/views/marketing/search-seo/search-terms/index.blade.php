<x-admin::layouts>
    ...
    {!! view_render_event('application.admin.marketing.search_seo.search_terms.create.before') !!}
    ...
    {!! view_render_event('application.admin.marketing.search_seo.search_terms.create.after') !!}
