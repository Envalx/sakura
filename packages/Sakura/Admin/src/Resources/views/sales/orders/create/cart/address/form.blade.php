    ...
    >
        <div class="mt-2">
            ...
            <div class="grid grid-cols-2 gap-x-5">
                ...
                {!! view_render_event('application.admin.sales.order.create.cart.address.form.company_name.after') !!}
                ...
                {!! view_render_event('application.admin.sales.order.create.cart.address.form.vat_id.after') !!}
            </div>
            ...
            <div class="grid grid-cols-2 gap-x-5">
                ...
                {!! view_render_event('application.admin.sales.order.create.cart.address.form.first_name.after') !!}
                ...
                {!! view_render_event('application.admin.sales.order.create.cart.address.form.last_name.after') !!}
            </div>
            ...
            {!! view_render_event('application.admin.sales.order.create.cart.address.form.email.after') !!}
            ...
            {!! view_render_event('application.admin.sales.order.create.cart.address.form.address.after') !!}
            ...
            <div class="grid grid-cols-2 gap-x-5">
                ...
                {!! view_render_event('application.admin.sales.order.create.cart.address.form.country.after') !!}
                ...
                {!! view_render_event('application.admin.sales.order.create.cart.address.form.state.after') !!}
            </div>
            ...
            <div class="grid grid-cols-2 gap-x-5">
                ...
                {!! view_render_event('application.admin.sales.order.create.cart.address.form.city.after') !!}
                ...
                {!! view_render_event('application.admin.sales.order.create.cart.address.form.postcode.after') !!}
            </div>
            ...
            {!! view_render_event('application.admin.sales.order.create.cart.address.form.phone.after') !!}
        </div>
    </script>
