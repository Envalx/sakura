{!! view_render_event('application.admin.sales.order.create.recent_order_items.before') !!}
...
{!! view_render_event('application.admin.sales.order.create.recent_order_items.after') !!}
