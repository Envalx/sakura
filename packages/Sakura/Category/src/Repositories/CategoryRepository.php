...
namespace Sakura\Category\Repositories;

use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Str;
use Intervention\Image\ImageManager;
use Sakura\Category\Contracts\Category;
use Sakura\Category\Models\CategoryTranslationProxy;
...
class CategoryRepository extends Repository
{
     ...
     * Create category.
     *
     * @return \Sakura\Category\Contracts\Category
     */
