...
namespace Sakura\Checkout;

use Illuminate\Support\Facades\Event;
use Sakura\Checkout\Contracts\CartAddress as CartAddressContract;
use Sakura\Checkout\Exceptions\BillingAddressNotFoundException;
use Sakura\Checkout\Models\CartAddress;
use Sakura\Checkout\Models\CartPayment;
use Sakura\Checkout\Repositories\CartAddressRepository;
use Sakura\Checkout\Repositories\CartItemRepository;
use Sakura\Checkout\Repositories\CartRepository;
use Sakura\Customer\Contracts\Customer as CustomerContract;
use Sakura\Customer\Contracts\Wishlist as WishlistContract;
use Sakura\Customer\Repositories\CustomerAddressRepository;
use Sakura\Customer\Repositories\WishlistRepository;
use Sakura\Product\Contracts\Product as ProductContract;
use Sakura\Product\Repositories\ProductRepository;
use Sakura\Shipping\Facades\Shipping;
use Sakura\Tax\Facades\Tax;
...
class Cart
{
     ...
     * The cart instance.
     *
     * @var \Sakura\Checkout\Contracts\Cart
     */
    private $cart;
