...
namespace Sakura\Core\Concerns;

use Sakura\Core\Contracts\Currency;
...
trait CurrencyFormatter
{
     ...
     *
     * @param  string|\Sakura\Core\Contracts\Currency  $currency
     */
    public function currencySymbol($currency): string
    {
        $code = $currency instanceof \Sakura\Core\Contracts\Currency ? $currency->code : $currency;
