    ...
    */
    'cache'      => [
       ...
       */
        ...
        'repositories' => [
            'Sakura\Core\Repositories\CoreConfigRepository' => [
                'enabled' => true,
            ...
            'Sakura\Core\Repositories\ChannelRepository' => [
                'enabled' => true,
            ],

            'Sakura\Core\Repositories\CountryRepository' => [
                'enabled' => true,
            ],

            'Sakura\Core\Repositories\CountryStateRepository' => [
                'enabled' => true,
            ],

            'Sakura\Core\Repositories\CurrencyRepository' => [
                'enabled' => true,
            ],

            'Sakura\Core\Repositories\LocaleRepository' => [
                'enabled' => true,
            ],
        ],
    ],
