...
use Sakura\Core\Concerns\CurrencyFormatter;
use Sakura\Core\Models\Channel;
use Sakura\Core\Repositories\ChannelRepository;
use Sakura\Core\Repositories\CountryRepository;
use Sakura\Core\Repositories\CountryStateRepository;
use Sakura\Core\Repositories\CurrencyRepository;
use Sakura\Core\Repositories\ExchangeRateRepository;
use Sakura\Core\Repositories\LocaleRepository;
use Sakura\Customer\Repositories\CustomerGroupRepository;
use Sakura\Tax\Repositories\TaxCategoryRepository;
...
class Core
{
     ...
     * @var string
     */
    const application_VERSION = '2.2.3';

    /**
     * Current Channel.
     *
     * @var \Sakura\Core\Models\Channel
     */
     ...
     * Currency.
     *
     * @var \Sakura\Core\Models\Currency
     */
     ...
     *
     * @var \Sakura\Customer\Models\CustomerGroup
     */
    ...
    {
        return static::application_VERSION;
    }
     ...
     *
     * @return \Sakura\Core\Contracts\Channel
     */
     ...
     *
     * @return \Sakura\Core\Contracts\Locale
     */
     ...
     *
     * @return \Sakura\Core\Contracts\Currency
     */
     ...
     *
     * @param  int|string|\Sakura\Core\Contracts\Channel  $channel
     ...
     *
     * @return \Sakura\Customer\Contract\CustomerGroup
     */
