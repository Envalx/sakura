...
namespace Sakura\Installer\Helpers;

use Exception;
use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Schema;
use Sakura\Installer\Database\Seeders\DatabaseSeeder as SakuraDatabaseSeeder;
use Sakura\Installer\Database\Seeders\ProductTableSeeder;
...
class DatabaseManager
{
    ...
    public function seeder($data)
    {
        ...
        try {
            app(SakuraDatabaseSeeder::class)->run($data['parameter']);
