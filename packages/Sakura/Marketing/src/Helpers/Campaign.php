...
namespace Sakura\Marketing\Helpers;

use Carbon\Carbon;
use Illuminate\Support\Facades\Mail;
use Sakura\Core\Models\SubscribersList;
use Sakura\Marketing\Mail\NewsletterMail;
use Sakura\Marketing\Repositories\CampaignRepository;
use Sakura\Marketing\Repositories\EventRepository;
...
class Campaign
{
     ...
     *
     * @param  \Sakura\Marketing\Contracts\Campaign  $campaign
     * @return array
     */
