...
use Sakura\Product\DataTypes\CartItemValidationResult;
use Sakura\Product\Facades\ProductImage;
use Sakura\Product\Repositories\ProductAttributeValueRepository;
use Sakura\Product\Repositories\ProductCustomerGroupPriceRepository;
use Sakura\Product\Repositories\ProductImageRepository;
use Sakura\Product\Repositories\ProductInventoryRepository;
...
abstract class AbstractType
{
     ...
     * Product instance.
     *
     * @var \Sakura\Product\Models\Product
     */
    protected $product;
     ...
     * Create product.
     *
     * @return \Sakura\Product\Contracts\Product
     */
    ...
    /**
     * @param  string  $code
     * @return \Sakura\Attribute\Contracts\Attribute
     */
     ...
     *
     * @param  \Sakura\Product\Models\Product  $product
     */
     ...
     * @return \Sakura\Product\Type\AbstractType
     */
     ...
     *
     * @param  \Sakura\Checkout\Contracts\CartItem  $cartItem
     * @return bool
     */
     ...
     *
     * @param  \Sakura\Checkout\Contracts\CartItem  $item
     * @return bool
     */
     ...
     *
     * @param  \Sakura\Attribute\Contracts\Group  $group
     ...
     * Get tax category.
     *
     * @return \Sakura\Tax\Models\TaxCategory
     */
     ...
     *
     * @param  \Sakura\Checkout\Contracts\CartItem  $item
     * @return \Sakura\Checkout\Contracts\CartItem|\Sakura\Sales\Contracts\OrderItem|\Sakura\Sales\Contracts\InvoiceItem|\Sakura\Sales\Contracts\ShipmentItem|\Sakura\Customer\Contracts\Wishlist
     */
     ...
     *
     * @param  \Sakura\Customer\Contracts\CartItem|\Sakura\Checkout\Contracts\CartItem  $item
     * @return array
     */
     ...
     */
    public function isCartItemInactive(\Sakura\Checkout\Contracts\CartItem $item): bool
    {
