...
use Sakura\Sales\Contracts\Invoice as InvoiceContract;
use Sakura\Sales\Database\Factories\InvoiceFactory;
use Sakura\Sales\Traits\InvoiceReminder;
use Sakura\Sales\Traits\PaymentTerm;
