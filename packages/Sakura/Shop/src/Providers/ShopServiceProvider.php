...
use Sakura\Shop\Http\Middleware\AuthenticateCustomer;
use Sakura\Shop\Http\Middleware\Currency;
use Sakura\Shop\Http\Middleware\Locale;
use Sakura\Shop\Http\Middleware\Theme;
