...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Авторское право 2010 - :current_year, Sakura Software (зарегистрировано в Индии). Все права защищены.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Авторское право 2010 - :current_year, Sakura Software (зарегистрировано в Индии). Все права защищены.',
                'locale'                 => 'Язык',
