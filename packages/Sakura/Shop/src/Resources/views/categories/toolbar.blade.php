{!! view_render_event('application.shop.categories.view.toolbar.before') !!}

<v-toolbar @filter-applied='setFilters("toolbar", $event)'></v-toolbar>

{!! view_render_event('application.shop.categories.view.toolbar.after') !!}

@inject('toolbar' , 'Sakura\Product\Helpers\Toolbar')
    ...
    >
        <div>
            ...
            <div class="flex justify-between max-md:hidden">
                {!! view_render_event('application.shop.categories.toolbar.filter.before') !!}
                ...
                {!! view_render_event('application.shop.categories.toolbar.filter.after') !!}

                {!! view_render_event('application.shop.categories.toolbar.pagination.before') !!}
                ...
                {!! view_render_event('application.shop.categories.toolbar.pagination.after') !!}
            </div>
