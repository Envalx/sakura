...
{!! view_render_event('application.shop.checkout.cart.summary.estimate_shipping.before') !!}
...
{!! view_render_event('application.shop.checkout.cart.summary.estimate_shipping.after') !!}
            ...
            <form @change="handleSubmit($event, estimateShipping)">
                ...
                >
                    <template v-for="method in methods">
                        {!! view_render_event('application.shop.checkout.onepage.shipping.before') !!}
                        ...
                        {!! view_render_event('application.shop.checkout.onepage.shipping.after') !!}
                    </template>
                </div>
            </form>                    
        </x-shop::form>
