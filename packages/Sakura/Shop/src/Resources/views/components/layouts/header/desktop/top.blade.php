{!! view_render_event('application.shop.components.layouts.header.desktop.top.before') !!}
...
{!! view_render_event('application.shop.components.layouts.header.desktop.top.after') !!}
...
@pushOnce('scripts')
    ...
    >
        <div class="flex w-full items-center justify-between gap-2">
            {!! view_render_event('application.shop.components.layouts.header.desktop.top.currency_switcher.before') !!}
            ...
            {!! view_render_event('application.shop.components.layouts.header.desktop.top.currency_switcher.after') !!}
            ...
            {!! view_render_event('application.shop.components.layouts.header.desktop.top.locale_switcher.before') !!}
            ...
            {!! view_render_event('application.shop.components.layouts.header.desktop.top.locale_switcher.after') !!}
        </div>
    </script>
    ...
    >
        <div class="my-2.5 grid gap-1 max-md:my-0">
            ...
            >
                <img
                    :src="locale.logo_url || '{{ application_asset('images/default-language.svg') }}'"
                    width="24"
                    height="16"
                />
