...
<div class="flex flex-wrap gap-4 px-4 pb-4 pt-6 shadow-sm lg:hidden">
    <div class="flex w-full items-center justify-between">
        ...
        <div class="flex items-center gap-x-1.5">
            {!! view_render_event('application.shop.components.layouts.header.mobile.drawer.before') !!}
            ...
            >
                ...
                <x-slot:content>
                    ...
                    <div class="mb-4 grid grid-cols-[auto_1fr] items-center gap-4 rounded-xl border border-zinc-200 p-2.5 max-md:mt-4">
                        <div>
                            <img
                                src="{{ auth()->user()?->image_url ??  application_asset('images/user-placeholder.png') }}"
                    ...
                    {!! view_render_event('application.shop.components.layouts.header.mobile.drawer.categories.before') !!}

                    <!-- Mobile category view -->
                    <v-mobile-category></v-mobile-category>

                    {!! view_render_event('application.shop.components.layouts.header.mobile.drawer.categories.after') !!}
                </x-slot>

                <x-slot:footer></x-slot>
            </x-shop::drawer>

            {!! view_render_event('application.shop.components.layouts.header.mobile.drawer.after') !!}

            {!! view_render_event('application.shop.components.layouts.header.mobile.logo.before') !!}
            ...
            {!! view_render_event('application.shop.components.layouts.header.mobile.logo.after') !!}
        </div>

        <!-- Right Navigation -->
        <div>
            <div class="flex items-center gap-x-5 max-md:gap-x-4">
                {!! view_render_event('application.shop.components.layouts.header.mobile.compare.before') !!}
                ...
                {!! view_render_event('application.shop.components.layouts.header.mobile.compare.after') !!}

                {!! view_render_event('application.shop.components.layouts.header.mobile.mini_cart.before') !!}

                @if(core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                    @include('shop::checkout.cart.mini-cart')
                @endif

                {!! view_render_event('application.shop.components.layouts.header.mobile.mini_cart.after') !!}
                    ...
                    <x-shop::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
                        ...
                        @guest('customer')
                            <x-slot:content>
                                ...
                                {!! view_render_event('application.shop.components.layouts.header.mobile.index.customers_action.before') !!}

                                <div class="mt-6 flex gap-4">
                                    {!! view_render_event('application.shop.components.layouts.header.mobile.index.sign_in_button.before') !!}
                                    ...
                                    {!! view_render_event('application.shop.components.layouts.header.mobile.index.sign_in_button.after') !!}
                                </div>

                                {!! view_render_event('application.shop.components.layouts.header.mobile.index.customers_action.after') !!}
                            </x-slot>
                        @endguest
                        ...
                        @auth('customer')
                            <x-slot:content class="!p-0">
                                ...
                                <div class="mt-2.5 grid gap-1 pb-2.5">
                                    {!! view_render_event('application.shop.components.layouts.header.mobile.index.profile_dropdown.links.before') !!}
                                    ...
                                    {!! view_render_event('application.shop.components.layouts.header.mobile.index.profile_dropdown.links.after') !!}
                                </div>
                            </x-slot>
                        @endauth
                    </x-shop::dropdown>
    ...
    >
        <div>
            <template v-for="(category) in categories">
                {!! view_render_event('application.shop.components.layouts.header.mobile.category.before') !!}
                ...
                {!! view_render_event('application.shop.components.layouts.header.mobile.category.after') !!}
            </template>
        </div>
                            ...
                            >
                                <img
                                    src="{{ ! empty(core()->getCurrentLocale()->logo_url)
                                            ...
                                            : application_asset('images/default-language.svg')
                                        }}"
                                    class="h-full"
                                    alt="Default locale"
                                    width="24"
