    ...
    >
        ...
        >
            <div class="relative max-h-[300px] max-w-[291px] overflow-hidden max-md:max-h-60 max-md:max-w-full max-md:rounded-lg max-sm:max-h-[200px] max-sm:max-w-full">
                {!! view_render_event('application.shop.components.products.card.image.before') !!}
                ...
                {!! view_render_event('application.shop.components.products.card.image.after') !!}

                <!-- Product Ratings -->
                {!! view_render_event('application.shop.components.products.card.average_ratings.before') !!}
                ...
                {!! view_render_event('application.shop.components.products.card.average_ratings.after') !!}
                ...
                <div class="action-items bg-black">
                    ...
                    <div class="opacity-0 transition-all duration-300 group-hover:bottom-0 group-hover:opacity-100 max-lg:opacity-100 max-sm:opacity-100">
                        ...
                        {!! view_render_event('application.shop.components.products.card.compare_option.before') !!}
                        ...
                        {!! view_render_event('application.shop.components.products.card.compare_option.after') !!}
            ...
            <div class="-mt-9 grid max-w-[291px] translate-y-9 content-start gap-2.5 bg-white p-2.5 transition-transform duration-300 ease-out group-hover:-translate-y-0 group-hover:rounded-t-lg max-md:relative max-md:mt-0 max-md:translate-y-0 max-md:gap-0 max-md:px-0 max-md:py-1.5  max-sm:min-w-[] max-sm:max-w-[192px]">

                {!! view_render_event('application.shop.components.products.card.name.before') !!}
                ...
                {!! view_render_event('application.shop.components.products.card.name.after') !!}

                <!-- Pricing -->
                {!! view_render_event('application.shop.components.products.card.price.before') !!}

                <div class="flex items-center justify-between gap-2.5">
                    <div
                        class="text-lg font-semibold max-sm:text-sm max-sm:leading-6"
                ...
                <div class="action-items flex items-center opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 max-md:hidden">
                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                        {!! view_render_event('application.shop.components.products.card.add_to_cart.before') !!}

                        <div class="flex items-center gap-2  justify-between w-full">
                            <div class="flex items-center border border-gray-200 rounded">
                                <button
                                    type="button"
                                    class="w-8 h-8 text-base text-gray-600 flex items-center justify-center border-r border-gray-200"
                                ...
                                <input
                                    type="text"
                                    class="w-10 h-8 text-center text-sm appearance-none"
                                    v-model="quantity"
                                ...
                                <button
                                    type="button"
                                    class="w-8 h-8 text-base text-gray-600 flex items-center justify-center border-l border-gray-200"
                                    @click="quantity++"
                                >
                                    +
                                </button>
                            ...
                            <button
                                class="secondary-button flex-1 p-2.5 text-sm font-medium max-sm:rounded-xl max-sm:p-2"
                        ...
                        {!! view_render_event('application.shop.components.products.card.add_to_cart.after') !!}
                    @endif

                    {!! view_render_event('application.shop.components.products.card.wishlist_option.before') !!}


                    {!! view_render_event('application.shop.components.products.card.wishlist_option.after') !!}
        ...
        >
            ...
            <div class="grid content-start gap-4">
                ...
                {!! view_render_event('application.shop.components.products.card.price.after') !!}
