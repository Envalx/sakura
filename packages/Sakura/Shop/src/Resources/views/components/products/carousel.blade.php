...
@pushOnce('scripts')
    ...
    >
        <div
            class="container mt-10 max-lg:px-8 max-md:mt-8 max-sm:mt-7 max-sm:!px-4"
        ...
        >
            ...
            <a
                :href="navigationLink"
                class="secondary-button mx-auto mt-2 block w-max rounded-2xl px-11 py-3 text-center text-base max-lg:mt-0 max-lg:hidden max-lg:py-3.5 max-md:rounded-lg"
                :aria-label="title"
                v-if="navigationLink"
            >
                @lang('shop::app.components.products.carousel.view-all')
