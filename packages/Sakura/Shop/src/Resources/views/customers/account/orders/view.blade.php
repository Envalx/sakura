    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-1.5">
                {!! view_render_event('application.shop.customers.account.orders.reorder_button.before', ['order' => $order]) !!}
                ...
                {!! view_render_event('application.shop.customers.account.orders.reorder_button.after', ['order' => $order]) !!}

                {!! view_render_event('application.shop.customers.account.orders.cancel_button.before', ['order' => $order]) !!}
                ...
                {!! view_render_event('application.shop.customers.account.orders.cancel_button.after', ['order' => $order]) !!}
            </div>
        </div>

        {!! view_render_event('application.shop.customers.account.orders.view.before', ['order' => $order]) !!}
                                ...
                                <div class="flex justify-end">
                                    <div class="grid max-w-max gap-2 text-sm">
                                        ...
                                        <div class="flex w-full justify-between gap-x-5">
                                            ...
                                            <p>
                                                @if($order->status !== \Sakura\Sales\Models\Order::STATUS_CANCELED)
                ...
                <div class="grid gap-1.5 rounded-md rounded-t-none border border-t-0 bg-white px-4 py-3 text-xs font-medium">
                    ...
                    @if ($order->shipping_address)
                        <div class="text-sm font-medium text-zinc-500">
                            ...
                            <div class="mt-1 grid gap-2 text-xs text-black">
                                ...
                                {!! view_render_event('application.shop.customers.account.orders.view.shipping_address_details.after', ['order' => $order]) !!}
                            </div>
                            
                            {!! view_render_event('application.shop.customers.account.orders.view.shipping_address.after', ['order' => $order]) !!}
                    ...
                    @if ($order->billing_address)
                        <div class="text-sm font-medium text-zinc-500">
                            ...
                            <div class="mt-1 grid gap-2 text-xs text-gray-800">
                                ...
                                {!! view_render_event('application.shop.customers.account.orders.view.billing_address_details.after', ['order' => $order]) !!}

                            </div>
        
                            {!! view_render_event('application.shop.customers.account.orders.view.billing_address.after', ['order' => $order]) !!}
                    ...
                    @if ($order->shipping_address)
                        <div class="text-sm font-medium text-zinc-500">
                            ...
                            <div class="mt-1 grid gap-2.5 text-xs text-gray-800">
                                ...
                                {!! view_render_event('application.shop.customers.account.orders.view.shipping_method_details.after', ['order' => $order]) !!}
                            </div>
        
                            {!! view_render_event('application.shop.customers.account.orders.view.shipping_method.after', ['order' => $order]) !!}
                    ...
                    <div class="text-sm font-medium text-zinc-500">
                        ...
                        <div class="mt-1 grid gap-2.5 text-xs text-black">
                            ...
                            {!! view_render_event('application.shop.customers.account.orders.view.payment_method_details.after', ['order' => $order]) !!}

                        </div>
                        
                        {!! view_render_event('application.shop.customers.account.orders.view.payment_method.after', ['order' => $order]) !!}
                    </div>
                </div>
            </div>
        ...
        {!! view_render_event('application.shop.customers.account.orders.view.after', ['order' => $order]) !!}
