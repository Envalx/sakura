...
{!! view_render_event('application.shop.products.view.attributes.before', ['product' => $product]) !!}
...
{!! view_render_event('application.shop.products.view.attributes.after', ['product' => $product]) !!}