@if (Sakura\Product\Helpers\ProductType::hasVariants($product->type))
    {!! view_render_event('application.shop.products.view.configurable-options.before', ['product' => $product]) !!}

    <v-product-configurable-options :errors="errors"></v-product-configurable-options>

    {!! view_render_event('application.shop.products.view.configurable-options.after', ['product' => $product]) !!}
    ...
    @push('scripts')
        ...
        <script type="module">
            ...
            app.component('v-product-configurable-options', {
                ...
                data() {
                    return {
                        config: @json(app('Sakura\Product\Helpers\ConfigurableOption')->getConfigurationConfig($product)),
