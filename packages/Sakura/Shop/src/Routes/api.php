...
use Sakura\Shop\Http\Controllers\API\AddressController;
use Sakura\Shop\Http\Controllers\API\CartController;
use Sakura\Shop\Http\Controllers\API\CategoryController;
use Sakura\Shop\Http\Controllers\API\CompareController;
use Sakura\Shop\Http\Controllers\API\CoreController;
use Sakura\Shop\Http\Controllers\API\CustomerController;
use Sakura\Shop\Http\Controllers\API\OnepageController;
use Sakura\Shop\Http\Controllers\API\ProductController;
use Sakura\Shop\Http\Controllers\API\ReviewController;
use Sakura\Shop\Http\Controllers\API\WishlistController;
